...
let IpfsController = class IpfsController {
    ...
    async uploadEncryptedAsset(file, title, type, content_hash, wallet_address, assigned_nominee_id) {
        if (!file) {
            throw new common_1.BadRequestException('Missing file (expected field "file")');
        }
        if (!file.buffer) {
            throw new common_1.BadRequestException('File buffer missing. Check multer memoryStorage() setup.');
        }
        if (!wallet_address) {
            throw new common_1.BadRequestException('Missing wallet_address');
        }
...
__decorate([
    ...
    __param(4, (0, common_1.Body)('wallet_address')),
    __param(5, (0, common_1.Body)('assigned_nominee_id')),
    __metadata("design:type", Function),
